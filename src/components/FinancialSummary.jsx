                    ...
                    <div className="space-y-12">
                        ...
                        <div>
                            <div className="flex justify-between items-end mb-2">
                                <h4 className="text-xl font-bold text-gray-500">Traditional ERP (Scenario A)</h4>
                                <span className="text-2xl font-bold text-gray-500">₹6,00,000+</span>
                            </div>
                            <div className="h-16 w-full bg-gray-100 rounded-full overflow-hidden relative flex items-center px-4">
                                <div
                                    ...
                                    style={{ width: '100%' }}
                                ></div>
                                <span className="relative z-10 text-white font-semibold flex justify-between w-full px-4">
                                    <span>High Setup + Implementation</span>
                                    <span>Recurring Annual Fees</span>
                        ...
                        <div>
                            <div className="flex justify-between items-end mb-2">
                                <h4 className="text-2xl font-bold text-blue-900">Creatzion Impact (Scenario B)</h4>
                                <span className="text-4xl font-bold text-green-600">~ ₹3,50,000</span>
                            </div>
                            <div className="h-20 w-full bg-gray-100 rounded-full overflow-hidden relative flex items-center">
                                ...
                                ></motion.div>
                                <span className="relative z-10 text-white font-bold text-lg px-8 drop-shadow-md">
